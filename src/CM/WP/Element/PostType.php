...
class CM_WP_Element_PostType extends CM_WP_Element {
	...
	protected function __construct(
		...
		if ( ! empty( $args['post_class'] ) ) {
			...
			unset( $args['post_class'] );
		}

		// Merge in the post arguments
		$this->post_args = shortcode_atts( $this->post_args, $args );
	}
	 ...
	 *                          value
	 *
	 * @throws CM_WP_Exception_Element_PostType_AlreadyRegisteredException if the post type is already registered
	 *
	...
	public function get( $post ) {
		...
		/** @var CM_WP_Element_PostType_Post $post_class */
